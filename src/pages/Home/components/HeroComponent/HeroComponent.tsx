...
export const HeroComponent = () => {
  ...
  const handleThemeSwitch =
    (themeOption: ThemeOptionType) => (event: MouseEvent) => {
      event.preventDefault();
      ...
      <div class={styles.heroSectionTop}>
        ...
        <div class={styles.heroSectionTopButtons}>
          ...
          <a
            ...
            target='_blank'
            class={styles.heroSectionTopDocButton}
          >
            <span class={styles.heroSectionTopDocButtonText}>
              See Documentation
            </span>

            <Fa
              icon={faArrowRightLong}
              class={styles.heroSectionTopDocButtonIcon}
            />
          </a>
        </div>
      </div>
          ...
          return (
            ...
            >
              <div class={styles.heroSectionBottomThemeOption}>
                <Icon class={styles.themeOptionIcon} />
              ...
              {themeOption.identifier === activeTheme?.identifier && (
                <>
                  ...
                  <div class={styles.themeOptionActiveLabel}>
                    {themeOption.label}
                  </div>
                </>
              )}
