...
export const HowToConnectComponent = () => {
  ...
  return (
    <div class={styles.howToConnectContainer}>
      <div class={styles.howToConnectHeader}>
        <h1 class={styles.howToConnectTitle}>How can you connect</h1>

        <p class={styles.howToConnectDescription}>
          Choose your path, you must.
        </p>
      </div>

      <div class={styles.howToConnectContent}>
        <ExtensionConnect />

        <div class={styles.howToConnectContentCards}>
