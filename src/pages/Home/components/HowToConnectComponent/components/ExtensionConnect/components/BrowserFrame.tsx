...
export const BrowserFrame = () => (
  <div class={styles.browserFrameContainer}>
    <div class={styles.browserFrameTopBar}>
      <div class={styles.browserFrameTopBarLeft}>
        {[...Array(3)].map((_) => (
          <span class={styles.browserFrameTopBarLeftDot} />
        ))}
      </div>

      <div class={styles.browserFrameTopBarRight}>
        <X />

        <div class={styles.browserFrameTopBarRightDots}>
          {[...Array(3)].map((_) => (
            <span class={styles.browserFrameTopBarRightDot} />
          ))}
        </div>
      </div>
    </div>

    <div class={styles.browserFrameScreenBg}>
      <div class={styles.browserFrameScreen} />
    </div>
  </div>
);
